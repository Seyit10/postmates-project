...
const SearchPage = () => {
    ...
    if(!results?.data || !city){
        return <span> Sonuç bulunamadı</span>;
    }
    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr] gap-5">
            ...
            <div id="main-content" className="flex flex-col gap-5">
                <SearchBar searchQuery={searchState.searchQuery} onSubmit={setSearchQuery} placeHolder="Mutfak veya Restoran Ara" onReset={resetSearch}/>
